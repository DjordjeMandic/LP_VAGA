...
/**
 * @brief Delay time (in milliseconds) after powering on the SIM800 GSM module before it can reliably operate.
 */
#define SIM800_POWER_DELAY_MS        5000
...
static_assert(SIM800_POWER_DELAY_MS >= 5000, "SIM800_POWER_DELAY_MS must be at least 5000 ms.");
 ...
 * 
 * - **Delay**: Requires 5000 ms after powering on.
 */
